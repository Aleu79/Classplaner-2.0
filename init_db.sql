...
CREATE TABLE classes (
    ...
    profesor BIGINT REFERENCES "user"(id) ON DELETE SET NULL,
    curso    VARCHAR(100),
    color    VARCHAR(100),
...
-- Muestra cada entrega realizada, con información del usuario y la tarea
...
-- 2. Resumen de cada clase (profesor, tareas y alumnos)
-- Cantidad de alumnos y tareas por clase
...
FROM classes c
LEFT JOIN "user" u ON u.id = c.profesor
...
-- Información general de cada tarea, su clase y profesor
...
-- 4. Progreso de usuarios (promedio de notas y entregas)
-- Cantidad de entregas y promedio de calificaciones por usuario
...
-- Lista todos los comentarios asociados a cada tarea
...
-- Promedio de calificaciones y cantidad de entregas por alumno
...
-- Estadísticas de alumnos, tareas y calificaciones por clase
...
-- Información completa de tareas y entregas de cada usuario
...
-- Total de tareas, entregas a tiempo, atrasadas y pendientes por clase
